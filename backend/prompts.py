...
- Include genre (e.g., "rap", "pop", "rock", "electronic", "rhumba", "gengetone", "reggae", "soul", "funk", "jazz", "classical", "country", "gospel", "blues")
- Include vocal type (e.g., "child vocal", "choir vocal", "base choir vocal", "male vocal", "female vocal", "spoken word", "instrumental")
- Include instruments actually heard (e.g., "guitar", "piano", "synthesizer", "drums", "bass", "violin", "trumpet")
- Include mood/energy (e.g., "energetic", "calm", "aggressive", "melancholic", "happy", "sad", "romantic", "nostalgic")
