...
import { renameSong, setPusblishedStatus } from "@/actions/song";
              ...
              switch (track.status) {
                case "failed":
                  return (
                    ...
                    >
                      <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-md bg-red-500/10">
                        <XCircle className="size-6 text-red-500" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <h3 className="truncate text-sm font-medium text-red-500">
                          Generation failed
                        </h3>
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className="text-muted-foreground truncate text-sm font-medium">
                          {track.status === "queued" ? (
                            <LoadingDots text="Song is Queued" />
                          ) : (
                            <LoadingDots text="Song is Processing" />
                          )}
                        </h3>
                        <p className="text-muted-foreground truncate text-xs">
                          Please refresh to check the status.
                        </p>
                      </div>
                    </div>
                  );
            ...
            <div className="flex flex-col items-center justify-center pt-20 text-center">
              ...
              <p className="text-muted-foreground mt-1 text-sm">
                {searchQuery
                  ...
                  : "Create a new track to get started"}
              </p>
            </div>
          )}
        </div>
